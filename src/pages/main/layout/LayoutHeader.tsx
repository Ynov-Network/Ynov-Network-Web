      ...
      <header className="bg-card backdrop-blur-xl border-b border-border px-6 py-4 sticky top-0 z-50 shadow-sm">
        <div className="flex items-center justify-between w-full">
          ...
          <div className={cn("flex-1 max-w-2xl", isMobile && "flex items-center gap-4")}>
            ...
            <div className="relative group w-full cursor-pointer" onClick={() => setOpenSearch(true)}>
              ...
              <Input
                ...
                className="pl-12 h-12 transition-all duration-300 w-full rounded-xl shadow-sm hover:shadow-md focus:shadow-lg pointer-events-none"
                readOnly
              />
