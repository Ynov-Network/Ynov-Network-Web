                  ...
                  <Card key={event.id} className="overflow-hidden hover:shadow-lg transition-all duration-300 hover-scale group cursor-pointer" >
                    <div className="relative" >
                      ...
                      <div className="absolute top-3 right-3 flex gap-2" >
                        <Button size="sm" variant="ghost" className="bg-white/90 hover:bg-white h-8 w-8 p-0" >
                          <Bookmark className={`h-4 w-4 ${event.isBookmarked ? 'text-ynov-primary fill-current' : 'text-gray-600'}`} />
                        </Button>
                        < Button size="sm" variant="ghost" className="bg-white/90 hover:bg-white h-8 w-8 p-0" >
                          <Share2 className="h-4 w-4 text-gray-600" />
                        </Button>
                      </div>
                      < Badge className="absolute top-3 left-3 bg-ynov-primary text-white" >
                        {event.category}
                      </Badge>
                    </div>

                    < CardHeader className="pb-3" >
                      <CardTitle className="text-lg leading-tight group-hover:text-ynov-primary transition-colors" >
                        {event.title}
                      </CardTitle>
                    </CardHeader>
                    ...
                    < CardContent className="space-y-4" >
                      ...
                      < div className="space-y-2 text-sm text-gray-600" >
                        ...
                        < div className="flex items-center gap-2" >
                          <Clock className="h-4 w-4 text-ynov-primary" />
                          <span>{event.time} </span>
                        </div>
                        < div className="flex items-center gap-2" >
                          <MapPin className="h-4 w-4 text-ynov-primary" />
